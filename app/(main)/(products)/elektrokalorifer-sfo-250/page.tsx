    ...
    <div className="@container w-full lg:overflow-x-auto">
      ...
      <section className="text-example space-y-4 text-[17px]">
        <h3 className="mb-2 text-xl">
          Оплата и доставка электрокалорифера СФО-250
        </h3>

        <div>
          <p>
            Заказать калорифер СФО-250 на нашем предприятии можно следующими
            способами:
          </p>
          <ul>
            <li>
        ...
        <div>
          <p>Способы оплаты электрического калорифера СФО-250:</p>
          <ul>
        ...
        <div>
          <p>Доставка калорифера СФО-250:</p>
          <ul>
            <li>
        ...
        <p className="text-base">
          Данные воздухонагревателя для транспортировки. Внешние габаритные
          размеры: 1.615 м х 0.720 м х 0.240 м; объем: 0.279 м<sup>3</sup>; вес
          калорифера: 82 кг.
        </p>
      </section>
    </div>
