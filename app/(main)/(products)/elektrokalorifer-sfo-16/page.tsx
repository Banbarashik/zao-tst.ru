  ...
  return (
    <section className="mb-4 space-y-4 text-[17px]">
      ...
      <p>
        ...
        до 130 м². Модель отличается высокой ремонтопригодностью и способностью
        эффективно работать с маломощными вентиляционными агрегатами в условиях
        ограниченного пространства. На основании проведенных расчетов выделены
        три ключевых сценария эксплуатации:
      </p>

      <ol className="space-y-4">
        {/* 1. Режим «Первого подогрева». Расход 1 800 м³/ч. */}
        <li className="space-y-2">
          ...
          <Spoiler title={<>Режимы работы СФО-16 при расходе 1 800 м³/ч</>}>
            <Analysis1800 />
          </Spoiler>
        </li>

        {/* 2. Режим «Вентиляционного преднагрева». Расход 2 000 м³/ч. */}
        <li className="space-y-2">
          <div>
            <p>
              <span className="text-example">
          ...
          <Spoiler title={<>Режимы работы СФО-16 при расходе 2 000 м³/ч</>}>
            <Analysis2000 />
          </Spoiler>
        </li>

        {/* 3. Режим «Вторичного догрева». Расход 2 200 м³/ч. */}
        <li className="space-y-2">
          <div>
            <p>
              <span className="text-example">
          ...
          <Spoiler title={<>Режимы работы СФО-16 при расходе 2 200 м³/ч</>}>
            <Analysis2200 />
          </Spoiler>
        </li>
      </ol>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            Рост производительности вентилятора (например, с 1800 до 2200 м³/ч)
            без снижения мощности. Повышенная скорость воздуха «сбивает»
            температуру металла за счет роста коэффициента теплоотдачи.
          </li>
          <li>
      ...
      <section className="border-primary rounded-lg border-l-4 pl-4">
        ...
        <p>
          ...
          эффективно отапливает помещения площадью до 150 м² при стандартной
          высоте потолков или до 100 м² в производственных зданиях с высотой до
          5 метров. Аппарат характеризуется двухсекционным разделением мощности
          и высоким коэффициентом байпаса, что определяет специфику его
  ...
  return (
    <section className={ANALYSIS_SECTION_CLASS}>
      <h3 className="mb-2 text-xl">
        Инженерный анализ режимов работы СФО-16 при расходе 1 800 м³/ч
      </h3>
      <p>
      ...
      <p className="text-[rgb(192,0,0)]">
        <span className="block">Общий вывод для 1 800 м³/ч:</span>
...
function Analysis2000() {
  return (
    <section className={ANALYSIS_SECTION_CLASS}>
      <h3 className="mb-2 text-xl">
        Инженерный анализ режимов работы СФО-16 при расходе 2 000 м³/ч
      </h3>
      <p>
        Производительность 2 000 м³/ч интенсифицирует конвективный теплообмен,
        снижая температурный напор на оболочке ТЭН. Работа на полной мощности
        становится более стабильной, позволяя эксплуатировать калорифер при
        околонулевых температурах на входе. Ступенчатое переключение мощности
        компенсирует суточные колебания температуры наружного воздуха. Расчет
        учитывает изменение кинематической вязкости и плотности среды,
      ...
      <p className="text-[rgb(192,0,0)]">
        <span className="block">Общий вывод для 2 000 м³/ч:</span>
...
function Analysis2200() {
  return (
    <section className={ANALYSIS_SECTION_CLASS}>
      <h3 className="mb-2 text-xl">
        Инженерный анализ режимов работы СФО-16 при расходе 2 200 м³/ч
      </h3>
      <p>
        Производительность 2 200 м³/ч характеризует эксплуатацию установки в
        режиме предельной массовой скорости для данного типа сечения. Повышение
        динамического напора в пучке нагревательных элементов усиливает
        турбулизацию потока. Это максимизирует коэффициент теплоотдачи и
        обеспечивает наилучшее охлаждение ТЭНов. Выводы сделаны на основе
      ...
      <p className="text-[rgb(192,0,0)]">
        <span className="block">Общий вывод для 2 200 м³/ч:</span>
