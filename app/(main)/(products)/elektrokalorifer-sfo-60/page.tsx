  ...
  return (
    <section className="mb-4 space-y-4 text-[17px]">
      ...
      <p>
        ...
        500–700 м². Модель характеризуется высокой удельной мощностью при малых
        габаритах корпуса, что требует точной настройки расхода воздуха. На
        основе теплофизических расчетов и итерационного анализа выделены три
        базовых сценария применения:
      </p>
      ...
      <ol className="space-y-4">
        ...
        <li className="space-y-2">
          ...
          <Spoiler title={<>Режимы работы СФО-60 при расходе 4 000 м³/ч</>}>
            <Analysis4000 />
          </Spoiler>
        </li>
        ...
        <li className="space-y-2">
          ...
          <Spoiler title={<>Режимы работы СФО-60 при расходе 5 000 м³/ч</>}>
            <Analysis5000 />
          </Spoiler>
        </li>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            Повышение расхода до 5 500 м³/ч интенсифицирует теплосъем, что
            позволяет оставить калорифер на полной мощности без вреда для
            конструкции, обеспечивая максимальный тепловой поток в помещение.
          </li>
          <li>
      ...
      <section className="border-primary rounded-lg border-l-4 pl-4">
        ...
        <p>
          ...
          вопрос отопления на площадях до 600 м². Напорный потенциал системы при
          использовании радиальных вентиляторов позволяет разводить воздух по
          воздуховодам, подавая тепло сразу в рабочие зоны (на высоте 2.5–3 м),
          что экономит до 20% энергии за счет исключения прогрева подкровельного
          пространства. Регулирование проводится как в ручном режиме, так и при
          помощи автоматики с датчиком температуры на поверхности ТЭНов для
          своевременного переключения ступеней мощности в зависимости от уличной
          температуры.
        </p>
      </section>
    </section>
...
function Analysis4000() {
  return (
    <section className={ANALYSIS_SECTION_CLASS}>
      ...
      <p>
        Производительность 4 000 м³/ч является нижним эксплуатационным порогом
        для работы СФО-60 на полную нагрузку. При таком расходе массовая
        скорость потока формирует максимально глубокий прогрев воздуха, но
        требуется строгий контроль активной мощности для предотвращения
        термического повреждения ТЭНов.
      </p>
      <ol className="space-y-4">
        <li className="space-y-2">
        ...
        <li className="space-y-2">
          ...
          <p className={TEXT_UNDER_ANALYSIS_TABLE_CLASS}>
            ...
            Сбалансированный режим для умеренных объёмов подачи{" "}
...
function Analysis5000() {
  return (
    <section className={ANALYSIS_SECTION_CLASS}>
      ...
      <p>
        Производительность 5 000 м³/ч является наиболее сбалансированным
        эксплуатационным режимом для модели СФО-60, при котором обеспечивается
        интенсивный теплосъем и стабильная работа нагревательных элементов в
        широком диапазоне внешних температур.
      </p>
      <ol className="space-y-4">
        <li className="space-y-2">
          <SFOOperatingParameterTable
...
function Analysis5500() {
  return (
    <section className={ANALYSIS_SECTION_CLASS}>
      ...
      <p>
        Производительность 5 500 м³/ч является максимальным эксплуатационным
        режимом для СФО-60. Данный расход воздуха является наиболее щадящим для
        ТЭНов за счет высокого коэффициента теплоотдачи. Основное внимание при
        проектировании следует уделить аэродинамике: высокое сопротивление
        холодного воздуха требует точного согласования с характеристиками
        вентилятора, однако взамен потребитель получает максимально надежную, с
        длительным сроком службы тепловую установку.
      </p>
      <ol className="space-y-4">
        <li className="space-y-2">
          <SFOOperatingParameterTable
          ...
          <p className={TEXT_UNDER_ANALYSIS_TABLE_CLASS}>
            ...
            подъём температуры на тридцать три градуса{" "}
        ...
        <li className="space-y-2">
          ...
          <p className={TEXT_UNDER_ANALYSIS_TABLE_CLASS}>
            ...
            рядов ТЭНов при данном обдуве создаёт стабильный тепловой фон с
        ...
        <li className="space-y-2">
          ...
          <p className={TEXT_UNDER_ANALYSIS_TABLE_CLASS}>
            ...
            контрольной точке оно падает до 95 Па за счёт значительного
            ...
            больших объёмах прокачки воздуха
          </p>
        </li>
      </ol>
      <p className="text-[rgb(192,0,0)]">
