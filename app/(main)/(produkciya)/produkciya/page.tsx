...
export const metadata: Metadata = {
  title:
    "Региональные отгрузки воздушно-отопительного оборудования | Завод Т.С.Т.",
  description:
    "География отгрузок промышленного воздушно-отопительного оборудования производства завода ООО «Т.С.Т.». Карта прямых поставок водяных, паровых и электрических калориферов и агрегатов. Спецификации заказов, подбор и доставка по регионам.",
  keywords:
    "производство промышленного воздушно отопительного оборудования,воздушно отопительное оборудование от производителя,география поставок калориферов и отопительных агрегатов,отгрузка калориферов и отопительных агрегатов со склада,калориферы водяные паровые электрические регионы доставки,калориферы и агрегаты воздушного отопления для сибири и крайнего севера,воздушное отопление предприятий в условиях резко континентального климата,эксплуатация калориферов в условиях экстремальной влажности,промышленные теплообменники для жестких и непрерывных цеховых режимов,промышленные водяные и паровые калориферы для тяжелой индустрии",
};
  ...
  return (
    <article className="@container w-full space-y-6">
      ...
      <ProductParagraph>
        ...
        в городе Киселевске Кемеровской области. За 25 лет профессиональной
        деятельности накоплен большой опыт по разработке, изготовлению и
        поставке теплообменной продукции для ключевых отраслей экономики страны:
        тяжелой индустрии, энергетики и агропромышленного комплекса.
      </ProductParagraph>
      ...
      <section className="space-y-4">
        ...
        <section className="space-y-4">
          ...
          <p className="text-secondary-text">
            ...
            в субъектах РФ и информация о сроках доставки до вашего города
            указаны на страницах соответствующих регионов.
          </p>
        </section>
      </section>
