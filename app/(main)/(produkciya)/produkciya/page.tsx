                ...
                children: (
                  <div className="space-y-4 p-4 text-[15px]">
                    <p className="italic">
                      ...
                      себя 57 городов и 66 иных населенных пунктов. Выберите
                ...
                children: (
                  <div className="space-y-4 p-4 text-[15px]">
                    <p className="italic">
                      ...
                      Отгрузки калориферов, отопительных агрегатов и
                      вентиляционных установок осуществляются на крупнейшие
                      машиностроительные, нефтегазовые, химические, кабельные,
                      автомобилестроительные и агропромышленные площадки
                ...
                children: (
                  <div className="space-y-4 p-4 text-[15px]">
                    <p className="italic">
                      ...
                      включающих в себя 43 города и 15 иных населенных пунктов.
