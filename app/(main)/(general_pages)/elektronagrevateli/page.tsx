    ...
    <>
      ...
      <section>
        ...
        <ProductParagraph>
          ...
          корпусе каждого электрокалорифера производства предприятия ООО
          «Т.С.Т.», имеется втулка с резьбой{" "}
      ...
      <section>
        ...
        <ProductParagraph className="mb-6">
          Электрические калориферы СФО подразделяются на семь типоразмеров.
          Геометрия и габаритные размеры корпусов электрокалориферов серии СФО
          стандартизированы для упрощения их интеграции в прямоугольные каналы
          промышленных вентиляционных систем. Линейка спроектирована по
          модульному принципу, что позволяет сохранять преемственность монтажных
          узлов при изменении мощности оборудования. Все модели имеют одинаковую
          ширину - 720 мм и глубину - 240 мм. Высота обогревателей варьируется
          от 230 до 1615 мм.
        </ProductParagraph>
        ...
        <section className={LEFT_BLUE_BRACKET}>
          ...
          <ul className="text-[17px]">
            <li>
              ...
              присоединительных размеров промышленного канального оборудования.
            </li>
            <li>
              ...
              рассчитано для безопасного размещения выводов ТЭНов, монтажных шин
              и подключения подводящих силовых линий. Наличие этих отсеков
              увеличивает габаритную ширину установки, но гарантирует надежную
              защиту электрической части. При проектировании трассировки
              кабельных лотков важно учитывать габаритный вылет боковых коробов
              для обеспечения свободного доступа сервисного персонала к клеммным
              зажимам.
            </li>
            <li>
            ...
            <li>
              ...
              пиковых токовых бросков в сети.
            </li>
          </ul>
        </section>
      </section>
      ...
      <ProductParagraph>
        Структура условного обозначения электрокалориферов СФО производства ООО
        «Т.С.Т.». Электрокалорифер СФО - Р/ 1Т-И2 УХЛ4 (ТУ
