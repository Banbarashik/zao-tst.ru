    ...
    <>
      ...
      <section className="space-y-2">
        ...
        <ProductParagraph>
          ...
          электродвигателем, смонтированные на общей сварной раме{" "}
      ...
      <LinkButtonsBlock
        buttons={[
          { name: "Выбор сечения кабеля", url: "/elektrokalorifery" },
          {
            name: "Подключение установок",
      ...
      <ProductParagraph>
        ...
        кВт; И2 - порядковый номер исполнения; УХЛ4 - климатическое исполнение и
