  ...
  return (
    <>
      ...
      <div className="mx-auto mb-14 w-full max-w-7xl">
        ...
        <p>
          География поставок воздушно-отопительного оборудования производства
          ООО «Т.С.Т.» представлена на динамической карте. Выберите интересующую
          вас область, чтобы открыть всплывающую таблицу и перейти к подробному
          референс-листу. На страницах регионов собраны спецификации выполненных
          отгрузок, зональные климатические параметры для теплотехнического
          моделирования, а также адреса местных транспортных терминалов и сроки
          доставки.
        </p>
      </div>
