    ...
    <>
      ...
      <main className="max-w-8xl mx-auto space-y-10 px-3 py-8 sm:px-6 sm:pt-11 lg:px-12 lg:pt-16">
        ...
        <div className="space-y-3">
          <p>
            Микроклимат обслуживаемых цехов и комплексов характеризуется рядом
          ...
          <p>
            Производство промышленного воздушно-отопительного оборудования, в
            том числе для эксплуатации в условиях крайне низких температур —
            основное направление деятельности завода ООО «Т.С.Т.» с 2001 года.
            Производственные мощности предприятия расположены в городе
            Киселевске Кемеровской области.
          </p>
        </div>
