  ...
  return (
    <>
      ...
      <main className="max-w-8xl mx-auto space-y-10 px-3 py-8 sm:px-6 sm:pt-11 lg:px-12 lg:pt-16">
        ...
        <p>
          Производство промышленного воздушно-отопительного оборудования, в том
          числе для эксплуатации в условиях крайне низких температур — основное
          направление деятельности завода ООО «Т.С.Т.» с 2001 года.
          Производственные мощности предприятия расположены в городе Киселевске
          Кемеровской области. Микроклимат обслуживаемых цехов и комплексов
          характеризуется рядом факторов, среди которых температура и влажность
          воздуха, скорость его движения. В холодный период года, ввиду разницы
          температуры снаружи и внутри здания, теплопотери помещения через
          ограждающие конструкции очень значительны. В целях создания и
          поддержания комфортных тепловых условий для работы необходим обогрев
          промышленных корпусов с помощью отопительного оборудования.
        </p>
        ...
        <section>
          <h2 className="mb-8 text-center text-base font-bold uppercase sm:text-lg md:text-xl lg:text-[22px] xl:text-2xl">
          ...
          <div className="mx-auto mb-14 w-full max-w-7xl">
            ...
            <div className="border-primary-dark mx-2 space-y-2 rounded-sm border p-3 shadow-md">
              <p>
                За 25 лет работы наше предприятие осуществило отгрузки в 70
                регионов страны, обеспечив надежным теплом сотни действующих
                промышленных объектов от Северо-Запада до Дальнего Востока.
                География выполненных поставок калориферов и отопительных
                агрегатов производства ООО «Т.С.Т.» представлена на динамической
                схеме. Выберите интересующую вас область, чтобы открыть
                всплывающую таблицу и перейти к подробному региональному
                референс-листу.
              </p>
              <p>
                Внутри каждого раздела доступен детальный список местных
                предприятий с указанием отгруженных моделей, а также расчетные
                зимние температуры региона по СП 131.13330, необходимые для
                вычисления проектной тепловой мощности оборудования. На примере
                реальных объектов вы можете оценить опыт эксплуатации наших
