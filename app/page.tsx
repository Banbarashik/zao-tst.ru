      ...
      <main className="max-w-8xl mx-auto space-y-10 px-3 py-8 sm:px-6 sm:pt-11 lg:px-12 lg:pt-16">
        ...
        <section>
          ...
          <p>
            ...
            «Т.С.Т.» представлена на динамической схеме.
          </p>
          ...
          <div className="mx-auto mb-2.5 max-w-237.5">
            <p className="text-center">Как работать с интерактивной картой:</p>
            <ul>
              <li>
          ...
          <p>
            ...
            вашего города и выбрать ближайшую транспортную компанию для
            доставки.
          </p>
        </section>
      </main>
