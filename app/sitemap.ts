...
const pathToImgFolders = {
  ...
  tehnicheskaya: `${pathToImgFolder}/tehnicheskaya`,
};
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${SITE_URL}/tehnicheskaya-stranica`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.9,
      images: [
        `${pathToImgFolders.tehnicheskaya}/agregat_avo_model.png`,
        `${pathToImgFolders.tehnicheskaya}/agregat_avo_model_voda.png`,
        `${pathToImgFolders.tehnicheskaya}/agregat_model.png`,
        `${pathToImgFolders.tehnicheskaya}/agregat_model_teplo.png`,
        `${pathToImgFolders.tehnicheskaya}/agregat_std_model.png`,
        `${pathToImgFolders.tehnicheskaya}/agregat_std_model_teplo.png`,
        `${pathToImgFolders.tehnicheskaya}/electro_model.png`,
        `${pathToImgFolders.tehnicheskaya}/electro_model_tenr.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_blok_par.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_electro.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_kamera_par.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_kamera_voda.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_par.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_pritok_par.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_pritok_voda.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_production.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_steam.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_model_voda.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_par_model_podbor.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_par_podbor.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_par_podbor_napor.png`,
        `${pathToImgFolders.tehnicheskaya}/kalorifer_podbor.png`,
        `${pathToImgFolders.tehnicheskaya}/ustanovka_model_electro.png`,
        `${pathToImgFolders.tehnicheskaya}/ustanovka_model_electro_kalor.png`,
    ...
    {
      url: `${SITE_URL}/elektrokalorifery`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
      images: [
        `${pathToImgFolders.generalPages}/kalorifer_sfo-16.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-16_electro.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-25.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-25_electro.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-40.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-40_electro.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-60.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-60_electro.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-100.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-100_electro.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-160.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-160_electro.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-250.png`,
        `${pathToImgFolders.generalPages}/kalorifer_sfo-250_electro.png`,
      ],
    },
    {
