  ...
  return (
    <ul className="flex flex-col items-center gap-10">
      ...
      <li className="flex w-full flex-col">
        ...
        <p>
          На страницах сайта мы постарались предоставить наиболее полную
          информацию по всему спектру выпускаемой продукции, включая
          теплотехнические характеристики, расчет и подбор, рабочие параметры
          эксплуатации. Ниже вы можете ознакомиться с реальным опытом применения
          нашего оборудования в климатических условиях вашего региона.
        </p>
      </li>
    </ul>
  );
