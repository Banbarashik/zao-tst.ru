...
const productCategories = [
  ...
  },
  {
    ...
    description:
      "Специализированные теплообменники и агрегаты в северном исполнении ХЛ обеспечивают стабильный нагрев воздуха даже при критическом падении наружной температуры. Это проверенное решение для вентиляционных систем предприятий, работающих в жестких климатических зонах страны.",
    items: [
      {
        name: "Калориферы ТВВ",
        url: "/catalog/tvv",
  ...
  },
  {
    ...
    description:
      "Помимо воздушного отопления производственных и складских помещений теплообменное оборудование нашего завода применяется с целью обеспечения технологических процессов в различных отраслях промышленности. Компонуемые в блоки водяные и паровые воздухонагреватели используются для подогрева воздуха - идущего на сушку и вентилирование сельскохозяйственных материалов, обработку древесины, проветривания горных выработок, создания и поддержания температурного режима покрасочных камер.",
    items: [
      {
  ...
  },
  {
    ...
    description:
      "Электрическое воздушное отопление целесообразно в помещениях, где нет подведенной тепловой сети и ее монтаж не представляется возможным. Электровоздушные установки и калориферы с оребренными трубчатыми нагревателями достаточно автономны в работе и для их подключения не требуется развернутых коммуникаций.",
    items: [
      {
        name: "Калориферы СФО",
        url: "/catalog/sfo",
  ...
  return (
    <ul className="flex flex-col items-center gap-10">
      ...
      <li className="flex w-full flex-col">
        <h2 className="text-base font-bold uppercase sm:text-lg md:text-xl lg:text-[22px] xl:text-2xl">
          Инженерный подбор калориферов и агрегатов
        </h2>
        ...
        <p>
          На страницах сайта предоставлена наиболее полная информация по всему
          спектру выпускаемой продукции, включая теплотехнические
          характеристики, расчет и подбор, рабочие параметры эксплуатации. Ниже
          вы можете ознакомиться с реальным опытом применения нашего
          оборудования в климатических условиях вашего региона.
        </p>
      </li>
    </ul>
  );
