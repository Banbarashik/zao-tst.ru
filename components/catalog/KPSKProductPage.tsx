...
export default function KPSKProductPage({ product }) {
  ...
  const productDesignText = {
    ksk: `Калорифер многоходовой ${product.shortName} выполнен в виде жесткого стального модуля с автономным гидравлическим трактом, включающим в себя элементы подвода, распределения и отвода теплоносителя. Нагревательные элементы изготовлены из металлических цилиндрических трубок с накатными алюминиевыми ребрами. Своими краями трубки вварены в трубные решетки, сверху которых монтируются распределительные коллектора. Для монтажа водяного калорифера к элементам вентиляционно-отопительной системы к торцам решеток прикручиваются съемные боковые щитки с присоединительными отверстиями. Совместно с трубными решетками они образуют кожух воздухонагревателя ${product.shortName}.`,
    ...
    <div className="@container w-full lg:overflow-x-auto">
      ...
      <section className="mb-10">
        ...
        <ProductParagraph className="mb-3">
          ...
          {engSeries === "ksk" &&
            `При установке калориферов в секции монтажные щитки демонтируются, теплообменники ${product.shortName} соединяются между собой и образуют сплошную поверхность нагрева без пропусков холодных воздушных струй.`}
          {engSeries === "kpsk" &&
